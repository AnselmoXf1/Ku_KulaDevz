              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                ...
                <div className="flex gap-3">
                  <motion.a
                    ...
                    className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200"
                    title="Instagram"
                  >
                  ...
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 rounded-xl bg-red-600 hover:bg-red-700 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200"
                    title="YouTube"
                  >
                    <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 rounded-xl bg-black hover:bg-gray-800 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200"
                    title="TikTok"
                  >
                    <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 rounded-xl bg-blue-700 hover:bg-blue-800 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200"
                    title="LinkedIn"
                  >
                    <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <motion.a
                    ...
                    className="w-12 h-12 rounded-xl bg-red-500 hover:bg-red-600 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200"
                    title="Email"
                  >
                    <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
